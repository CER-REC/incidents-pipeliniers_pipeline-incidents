...
const TranslationTable = Immutable.fromJS({ 
  ...
  tooltips: {
    ...
    company: {
      ...
      detail: {
        en: [
          ...
          {overview:'Pouce Coupï¿½ Pipe Line Ltd. as agent and general partner of the Pembina North Limited Partnership', expanded:null},
    ...
    pipelineSystemComponentsInvolved: {
      ...
      description: {
        en: 'The type of equipment or components involved in the incident. Data available from 2015 to current.\nComponents in this case refer to a segment of the piping that is designed to maintain pipe pressure but is not the main body of the pipe. Examples include a pipe elbow or flange.',
        fr: 'Type d’équipement ou composantes qui sont en cause dans l’incident. Données disponibles de 2015 à aujourd’hui.\nDans ce cas, les composantes désignent une section de tuyauterie conçue pour supporter la pression à l’intérieur de la conduite, sans être le corps principal de la canalisation comme, par exemple, un coude ou une bride.',
      },
      detail: {
        en: [
